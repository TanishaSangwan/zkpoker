...
export const pokerGameAbi = [
  ...
  {
    "type": "event",
    "name": "zkpoker::PokerGame::ShowdownStarted",
    "kind": "struct",
    "members": [
      {
        "name": "table_id",
  ...
  {
    "type": "event",
    "name": "zkpoker::PokerGame::SeatForfeited",
    "kind": "struct",
    "members": [
      {
        "name": "table_id",
  ...
  {
    "type": "event",
    "name": "zkpoker::PokerGame::BlindScheduleSet",
    "kind": "struct",
    "members": [
      {
        "name": "table_id",
  ...
  },
  {
    ...
    "variants": [
      ...
      },
      {
        ...
        "type": "zkpoker::PokerGame::ShowdownStarted",
        "kind": "nested"
      },
      {
      ...
      {
        "name": "SeatForfeited",
        "type": "zkpoker::PokerGame::SeatForfeited",
        "kind": "nested"
      },
      {
